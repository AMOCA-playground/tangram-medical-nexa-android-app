 ...
 * The time per character (ms/char) values obtained from this test are used to calibrate the progress
 * simulation speed constants in ProgressSimulator.kt for estimating LLM processing duration.
 *
 * USAGE:
    ...
    private suspend fun benchmarkTask(
        ...
        for (length in testLengths) {
            ...
            for (runIndex in 1..runsPerLength) {
                ...
                val totalInputChars = result.third
