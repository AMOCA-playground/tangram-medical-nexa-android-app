    ...
    Box(
        ...
        Column(
            ...
            Column(
                modifier = Modifier
                    .fillMaxSize()
                    .padding(horizontal = AppDimens.spacingMedium, vertical = AppDimens.spacingSmall),
                ...
                Text(
                    ...
                    modifier = Modifier.padding(top = AppDimens.spacingLarge)
                )
            }
        }
        ...
        Box(
            ...
            Box(
                modifier = Modifier
                    .size(AppDimens.iconSizeDefault)
                    .background(
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = { 
                    ...
                    Text("Discard", color = AppColors.AccentRed)
                }
            },
            dismissButton = {
